...
const EditBook = () => {
    ...
    useEffect(() => {
        ...
        axios.get(`http://localhost:3004/book/${id}`)
            .then(res => {
                setBook(res.data)
    ...
    const handleSubmit = (e) => {
        ...
        axios.put(`http://localhost:3004/book/${id}`, updatedBook)
    ...
    return (
        <div className="register-container">
            <form className="add-book-form" onSubmit={handleSubmit}>
                <Link to="/books" className="btn btn-outline-warning w-25">Back</Link>
                ...
                <div style={{width:"80%",display:"flex",justifyContent:"space-between"}}>
                    
                    {
                        role === "manager" && (
                            <>
                                <Link to="/books" className="btn btn-outline-danger pt-2 w-50">Delete</Link>
